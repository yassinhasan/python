def email_tempevents(email,subject,message):  
    part1 = """ <!DOCTYPE html>
    <head>
        <style type="text/css">
            body {
    ...
    part6 = f"""
            <tr>
                <td align="center">
                    <div style="color: #e4e0e0; font-size: 18px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;width:100%"width="100%">
                        {message}
                    </div> 
                </td>
            </tr>

...
def handle_logged_in_user(database, template_name, pagetitle):
    """
...
def handle_token_authentication(token, database, admin_auth, template_name, pagetitle):
    """
    ...
    try:
        ...
        return handle_unauthenticated_user("You should login first or Token is invalid!!")

def handle_unauthenticated_user(message=None):
